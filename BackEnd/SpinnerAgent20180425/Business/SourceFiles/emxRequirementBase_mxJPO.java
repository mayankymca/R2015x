...
06/03/2015      LX6                 2015x   IR-374998-3DEXPERIENCER2015x Requirement: When refining requirements, Change of relationship status of requirement in drop down menu is not getting saved properly.
06/10/2017      KIE1 		ZUD  	2015x	IR-537609-3DEXPERIENCER2015x: List of requirement specs disappears or gives java error when sorting on column 
*/
...
// End:R207:RMT Bug 331464
        ...
        throws Exception
    {
        ...
        for(int i = list.size() - 1; i >= 0; i--){
            ...
            if(RequirementsUtil.getRequirementVersionPolicy(context).equals(policy)){
                list.remove(i);
            }
            
            // KIE1 added
            Map listMap  = (Map)list.get(i);
            Map reqMap = (Map)Reqs.get(i);
            
            String access = (String)reqMap.get(RequirementsConstants.SELECT_READ_ACCESS);
            if(access == null || RequirementsConstants.DENIED.equals("access")){
            	listMap.put("objReadAccess", "FALSE");
            }else{
            	listMap.put("objReadAccess", "TRUE");
            }
        }
        return list;
    }
        ...
        throws Exception
    {
		...
		String strWhereExpression = "policy != '" + RequirementsUtil.getRequirementVersionPolicy(context) + "'";
        ...
        throws Exception
    {
        ...
        strWhereExpression = SYMB_OPEN_PARAN + strWhereExpression + SYMB_CLOSE_PARAN + SYMB_AND + SYMB_OPEN_PARAN + "policy != '" + 
                                           RequirementsUtil.getRequirementVersionPolicy(context) + "'" + SYMB_CLOSE_PARAN;
        ...
        throws Exception
    {
        ...
        String strSubRequirementReln = RequirementsUtil.getSubRequirementRelationship(context);
        String strFeatureRequirementReln = RequirementsUtil.getRequirementSatisfiedByRelationship(context);
        String strProductRequirementReln = RequirementsUtil.getProductRequirementRelationship(context);
        String strComma = ",";
        ...
        setId(strObjectId);
        short sh = 1;
        String strType = RequirementsUtil.getRequirementType(context);
        ...
        throws Exception
    {
        ...
        String strRelationship = RequirementsUtil.getSubRequirementRelationship(context);
        String strType = RequirementsUtil.getRequirementType(context);
        //Domain Object initialized with the object id.
        setId(strObjectId);
        short sh = 1;
        ...
        throws Exception
    {
        ...
        String strRelationship = RequirementsUtil.getRequirementSatisfiedByRelationship(context);
        //Domain Object initialized with the object id.
        setId(strObjectId);
        short sh = 1;
        ...
        throws Exception
    {
        ...
        StringList objectSelects = new StringList(DomainConstants.SELECT_ID);
        objectSelects.addElement(RequirementsConstants.SELECT_READ_ACCESS);
        String strType = RequirementsUtil.getRequirementType(context);
        ...
        throws Exception
    {
        ...
        Pattern relPattern = new Pattern(RequirementsUtil.getSubRequirementRelationship(context));
        relPattern.addPattern(RequirementsUtil.getDerivedRequirementRelationship(context));
        relPattern.addPattern(RequirementsUtil.getRequirementValidationRelationship(context));
        relPattern.addPattern(RequirementsUtil.getRequirementUseCaseRelationship(context));

        // include type 'Requirement, Test Case' and 'Use Case' in Requirement structure navigation list
        Pattern typePattern = new Pattern(RequirementsUtil.getRequirementType(context));
        typePattern.addPattern(RequirementsUtil.getUseCaseType(context));
        typePattern.addPattern(RequirementsUtil.getTestCaseType(context));
        //relPattern.addPattern(RequirementsUtil.getParameterUsageRelationship(context));
        //typePattern.addPattern(RequirementsUtil.getParameterType(context));
        ...
        if (objectParentType != null && objectParentType.equals(RequirementsUtil.getRequirementType(context)))
        {
            try
            {
    ...
    public int checkSubRequirementRelease(Context context, String[] args)
        throws Exception
    {
        return checkChildRequirementRelease(context, args, RequirementsUtil.getSubRequirementRelationship(context));
	}
    ...
    public int checkDerivedRequirementRelease(Context context, String[] args)
        throws Exception
    {
        return checkChildRequirementRelease(context, args, RequirementsUtil.getDerivedRequirementRelationship(context));
	}
//Start IR-187552V6R2014 LX6
    ...
    public int checkChildParameterRelease(Context context, String[] args)
        throws Exception
    {	String RelTypes = RequirementsUtil.getParameterUsageRelationship(context) + "," + RequirementsUtil.getParameterAggregationRelationship(context);
...
//Start IR-187552V6R2014 LX6            
            ...
            if(relationship.contains(RequirementsUtil.getParameterUsageRelationship(context))||
               relationship.contains(RequirementsUtil.getParameterAggregationRelationship(context)))
            {
            	strTypePattern = RequirementsUtil.getParameterType(context);
            ...
            {
            	STATE_RELEASE = FrameworkUtil.lookupStateName(context, RequirementsUtil.getRequirementPolicy(context), SYMBOLIC_STATE_RELEASE);
            	STATE_OBSOLETE = FrameworkUtil.lookupStateName(context, RequirementsUtil.getRequirementPolicy(context), SYMBOLIC_STATE_OBSOLETE);
            	strTypePattern = RequirementsUtil.getRequirementType(context);
            }
//End IR-187552V6R2014 LX6            
...
//End IR-187552V6R2014 LX6				
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            String strRelease = FrameworkUtil.lookupStateName(context, RequirementsUtil.getRequirementPolicy(context), SYMBOLIC_STATE_RELEASE);
            String strObsolete = FrameworkUtil.lookupStateName(context, RequirementsUtil.getRequirementPolicy(context), SYMBOLIC_STATE_OBSOLETE);
     ...
     */
         ...
         throws Exception
     {
        ...
        try
        {
            String strProdRequirementReln = RequirementsUtil.getProductRequirementRelationship(context);
            String strType = RequirementsUtil.getProductsType(context);
            ...
            String strBusWhereClause = "";
            String strRelWhereClause = DomainConstants.EMPTY_STRING;
            String strRelease = FrameworkUtil.lookupStateName(context, RequirementsUtil.getProductPolicy(context), SYMBOLIC_STATE_RELEASE);
     ...
     */
         ...
         throws Exception
     {
        ...
        try
        {
            String strSatisfiedRequirementReln = RequirementsUtil.getRequirementSatisfiedByRelationship(context);
            String strType = RequirementsUtil.getFeatureType(context);
            List lstObjSelects = new StringList(DomainConstants.SELECT_ID);
            //Begin of Add by Enovia MatrixOne for Bug# 300088 on 30-Mar-05
            lstObjSelects.add(DomainConstants.SELECT_TYPE);
            lstObjSelects.add(DomainConstants.SELECT_NAME);
            ...
            String strBusWhereClause = "";
            String strRelWhereClause = DomainConstants.EMPTY_STRING;
            String strRelease = FrameworkUtil.lookupStateName(context, RequirementsUtil.getProductFeaturePolicy(context), SYMBOLIC_STATE_RELEASE);
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            sbBuffer.append(RequirementsUtil.getRequirementType(context));
            ...
            stbTypeSelect.append(RequirementsUtil.getRequirementType(context));
            ...
            stbRelSelect = stbRelSelect.append(RequirementsUtil.getProductRequirementRelationship(context))
                                       .append(SYMB_COMMA)
                                       .append(RequirementsUtil.getSubRequirementRelationship(context));
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            List lstProductChildTypes=ProductLineUtil.getChildrenTypes(context, RequirementsUtil.getProductsType(context));
            ...
            List lstModelChildTypes=ProductLineUtil.getChildrenTypes(context, RequirementsUtil.getModelType(context));
            lstModelChildTypes.add(RequirementsUtil.getModelType(context));
            //end of add

            if (lstProductChildTypes.contains(strType))
            {
                sbTypeSelect.append(RequirementsUtil.getRequirementType(context));
                ...
                sbRelSelect = sbRelSelect.append(RequirementsUtil.getProductRequirementRelationship(context))
                                         .append(SYMB_COMMA)
                                         .append(RequirementsUtil.getSubRequirementRelationship(context));
                bRefDoc=false;
            }
            ...
            else if (lstModelChildTypes.contains(strType))
            {
                ...
                sbRelSelect = sbRelSelect.append(RequirementsUtil.getCandidateItemRelationship(context));
                bRefDoc=false;

            }
            //end of add
            else if (lstReqChildTypes.contains(strType) || RequirementsUtil.getRequirementType(context).equals(strType))
            {
                sbTypeSelect.append(RequirementsUtil.getRequirementType(context));
                sbTypeSelect.append(SYMB_COMMA);
                for (int i=0; i < lstReqChildTypes.size(); i++)
                ...
                sbTypeSelect = sbTypeSelect.append(SYMB_COMMA)
                                           .append(RequirementsUtil.getTestCaseType(context))
                                           .append(SYMB_COMMA)
                                           .append(RequirementsUtil.getUseCaseType(context))
                                           .append(SYMB_COMMA)
                                           .append(RequirementsUtil.getRequirementSpecificationType(context) )
                                           .append(SYMB_COMMA)
                                           .append(RequirementsUtil.getDocumentType(context));
                ...
                sbRelSelect = sbRelSelect.append(RequirementsUtil.getProductRequirementRelationship(context))
                                         ...
                                         .append(RequirementsUtil.getSubRequirementRelationship(context))
                                         .append(SYMB_COMMA)
                                         .append(RequirementsUtil.getRequirementUseCaseRelationship(context))
                                         .append(SYMB_COMMA)
                                         .append(RequirementsUtil.getRequirementValidationRelationship(context))
                                         .append(SYMB_COMMA)
                                         .append(RequirementsUtil.getRequirementSpecificationRelationship(context));

            }
            else if (strType.equals(RequirementsUtil.getTestCaseType(context)))
            {
                sbTypeSelect = sbTypeSelect.append(RequirementsUtil.getTestCaseType(context));
                sbRelSelect = sbRelSelect.append(RequirementsUtil.getSubTestCaseRelationship(context));
            }
            else if (strType.equals(RequirementsUtil.getUseCaseType(context)))
            {
                sbTypeSelect = sbTypeSelect.append(RequirementsUtil.getTestCaseType(context))
                                           .append(SYMB_COMMA)
                                           .append(RequirementsUtil.getUseCaseType(context));
                sbRelSelect = sbRelSelect.append(RequirementsUtil.getSubUseCaseRelationship(context))
                                         .append(SYMB_COMMA)
                                         .append(RequirementsUtil.getUseCaseValidationRelationship(context));
            }
            ...
            if (bRefDoc)
            {
                MapList mapTDocuments=domObject.getRelatedObjects(context, RequirementsUtil.getReferenceDocumentRelationship(context),
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            if (lstReqChildTypes.contains(strType) || RequirementsUtil.getRequirementType(context).equals(strType))
            {
                bReqTypeFlag=true;
            }
            ...
            if (bReqTypeFlag)
            {
                ...
                List lstFeatureChildTypes = ProductLineUtil.getChildrenTypes(context, RequirementsUtil.getFeaturesType(context));
                ...
                tMaplist=domObject.getRelatedObjects(context, RequirementsUtil.getRequirementSatisfiedByRelationship(context),
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            while(objectListItr.hasNext())
            {
                ...
                else if (lstReqChildTypes.contains(strObjType) || RequirementsUtil.getRequirementType(context).equals(strObjType))
                {
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            for(int i=0;i<iMapSize;i++)
            {
                ...
                mapFeatures = domInter.getRelatedObjects(context, RequirementsUtil.getRequirementSatisfiedByRelationship(context),
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            MapList tMList = domObj.getRelatedObjects(context, RequirementsUtil.getSubRequirementRelationship(context),
                    sbBuffer.toString(), new StringList(DomainConstants.SELECT_ID), null, false, true, (short)1, null, null);

            if (tMList.isEmpty())
            {
                tMList=domObj.getRelatedObjects(context, RequirementsUtil.getRequirementSatisfiedByRelationship(context),
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            StringBuffer stbRelSelect = new StringBuffer(50);
            stbRelSelect = stbRelSelect.append(RequirementsUtil.getFeatureListFromRelationship(context))
                                       .append(SYMB_COMMA)
                                       .append(RequirementsUtil.getFeatureListToRelationship(context));
            StringBuffer sbBufferType=new StringBuffer(100);
            List lstFeatureChildTypes = ProductLineUtil.getChildrenTypes(context, RequirementsUtil.getFeaturesType(context));
            for (int i=0; i < lstFeatureChildTypes.size(); i++)
            {
            ...
            sbBufferType.append(SYMB_COMMA)
                        .append(RequirementsUtil.getFeatureListType(context))
                        .append(SYMB_COMMA)
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            while( mItr.hasNext() )
            {
                ...
                if ( parentType.equals(RequirementsUtil.getDocumentsType(context)) )
                {
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            while( mItr.hasNext() )
            {
                ...
                if (RequirementsUtil.getDocumentsType(context).equals(parentType) )
                {
                    if (!isprinterFriendly)
                    {
    ...
    public MapList getDerivedRequirements(Context context, String[] args)throws Exception
    {
        ...
        try
        {
            ...
            int maxLevels = Integer.parseInt(expLevel);
            //START : LX6 IR-374998-3DEXPERIENCER2015x When refining requirements, Change of relationship status of requirement 
            ...
            //END : LX6 IR-374998-3DEXPERIENCER2015x When refining requirements, Change of relationship status of requirement 
            //in drop down menu is not getting saved properly.
            ...
            if (lstReqChildTypes.contains(strType) || RequirementsUtil.getRequirementType(context).equals(strType))
            {
                ...
                sbRelSelect = sbRelSelect.append(RequirementsUtil.getDerivedRequirementRelationship(context));
    ...
    public MapList getRequirementChildren(Context context, String[] args)throws Exception
    {
        ...
        try
        {
            ...
            //Adding Parameter
            lstReqChildTypes.add(RequirementsUtil.getParameterType(context));
            //Adding Test Case
			lstReqChildTypes.add(RequirementsUtil.getTestCaseType(context));
            //Code to be added
            ...
            if (lstReqChildTypes.contains(strType) || RequirementsUtil.getRequirementType(context).equals(strType))
            {
                ...
                sbRelSelect = sbRelSelect.append(RequirementsUtil.getSubRequirementRelationship(context))
                                         ...
                                         .append(RequirementsUtil.getDerivedRequirementRelationship(context))
                                         .append(SYMB_COMMA)
                                         .append(RequirementsUtil.getParameterAggregationRelationship(context))
                						 .append(SYMB_COMMA)
                                         .append(RequirementsUtil.getParameterUsageRelationship(context))
										 .append(SYMB_COMMA)
										 .append(RequirementsUtil.getRequirementValidationRelationship(context))
										 .append(SYMB_COMMA)
										 .append(RequirementsUtil.getSubTestCaseRelationship(context));
    ...
    public List getRelatedSpecifications (Context context, String[] args) throws Exception
    {
        ...
        StringList specList;
        StringBuffer sbTypeSelect=new StringBuffer(60);
        sbTypeSelect.append(RequirementsUtil.getSpecificationType(context));
        sbTypeSelect.append(SYMB_COMMA);
        sbTypeSelect.append(RequirementsUtil.getChapterType(context));

        DomainObject domObj = null;
        // mqlcommand retrieves all the derivatives of type Specification
        String strQuery = "print type $1 select $2 dump $3";
        String strResult = MqlUtil.mqlCommand(context, strQuery, RequirementsUtil.getSpecificationType(context), "derivative", ",");
        ...
        while(objectListItr.hasNext())
        {
            ...
            MapList specObjMapList = domObj.getRelatedObjects(context,RequirementsUtil.getSpecStructureRelationship(context),
    ...
    public List getOtherRelatedRequirements (Context context, String[] args) throws Exception
    {
        ...
        while(objectListItr.hasNext())
        {
            ...
            relNamesBuffer.append(RequirementsUtil.getSubRequirementRelationship(context));
            relNamesBuffer.append(SYMB_COMMA);
            relNamesBuffer.append(RequirementsUtil.getDerivedRequirementRelationship(context));
            relNamesBuffer.append(SYMB_COMMA);
            ...
            MapList specObjMapList = domObj.getRelatedObjects(context, relNamesBuffer.toString(), RequirementsUtil.getRequirementType(context),
    ...
    public MapList expandSpecificationObjects(Context context, String[] args)throws Exception
    {
        ...
        try
        {
            ...
            specList = domObject.getRelatedObjects(context,  RequirementsUtil.getSpecStructureRelationship(context),
                    RequirementsUtil.getChapterType(context), selectStmts, selectRelStmts, false, true, (short)1, null, null);
    ...
    public int revisedParentRequirement(Context context, String[] args)throws Exception
    {
        ...
        try
        {
            ...
            connReqObjList=domRevisedObject.getRelatedObjects(context, relNamesBuffer.toString(), RequirementsUtil.getRequirementType(context),
                    null, selectRelStmts, false, true, (short)1, null, null);

            
            String attLinkStatus = RequirementsUtil.getLinkStatusAttrubite(context);
            // Iterating through each  Requirement Object and making it hyperlink
    ...
    public MapList getRequirementSpecifications (Context context, String[] args) throws Exception
    {
        ...
        String strSpecStructReln = RequirementsUtil.getSpecStructureRelationship(context);
        ...
        List lstSpecChildTypes=ProductLineUtil.getChildrenTypes(context, RequirementsUtil.getSpecificationType(context));
        StringBuffer sbBuffer = new StringBuffer(100);
        sbBuffer.append(RequirementsUtil.getSpecificationType(context));
        sbBuffer.append(SYMB_COMMA);
    ...
    {
		//String selectString = "from["+RequirementsUtil.getRequirementDecisionRelationship(context)+"].to.id";
		String selectString = "to["+RequirementsUtil.getDecisionRelationship(context)+"].from.id";
...
/** Utility method for revision triggers
        ...
        throws Exception
    {
        try
        {
            String strRelPattern = RequirementsUtil.getSubRequirementRelationship(context) + "," + RequirementsUtil.getDerivedRequirementRelationship(context);
            ...
            String strReleaseReq = FrameworkUtil.lookupStateName(context, RequirementsUtil.getRequirementPolicy(context), "state_Release");
            String strObsoleteReq = FrameworkUtil.lookupStateName(context, RequirementsUtil.getRequirementPolicy(context), "state_Obsolete");
	...
	* @param args JPO arguments
	...
	public MapList getRequirementVersions(Context context, String[] args) throws Exception
	{
		...
		short sRecursionLevel = 1;
		String strType = RequirementsUtil.getRequirementType(context);
		String strRelName = RequirementsUtil.getRequirementVersionRelationship(context);
        ...
        throws Exception
    {
        ...
        String strRelWhereClause = "type != '" + RequirementsUtil.getRequirementVersionRelationship(context) + "' && type != '" + RequirementsUtil.getThreadRelationship(context) + "' && type != '" + RequirementsUtil.getPublishSubscribeRelationship(context) + "'";
...
//        For this purpose filtering out the unwanted Decision objects.
        ...
        String strParentReqId = getInfo(context, "to[" + RequirementsUtil.getRequirementVersionRelationship(context) + "].from.id");
        if (strParentReqId != null && !"".equals(strParentReqId)) {
            ...
            MapList mlParentDecisions = dmoParentReq.getRelatedObjects(context,
                                                                       RequirementsUtil.getDecisionType(context),
                                                                       RequirementsUtil.getDecisionRelationship(context),
                                                                       objectSelects,
                                                                       null,
                                                                       true,
                                                                       false,
    ...
    private boolean isVersionObject(Context context, String objectId) throws Exception
    {
        ...
        return RequirementsUtil.getRequirementVersionPolicy(context).equals(policy);
    ...
    throws Exception
    {
    	 StringList excludeList = new StringList();
    	  StringList objectSelects = new StringList(DomainConstants.SELECT_ID);
          String strType = RequirementsUtil.getDecisionType(context);
    	 //The findobjects method is invoked to get the list of products
          ...
          for(int itr = 0; itr < mapBusIds.size(); itr++){
				...
				if(null != strState && !strState.equalsIgnoreCase(RequirementsConstants.STATE_ACTIVE)){
    ...
    public static Object getDesignatedUser(Context context, String args[]) throws Exception
    {
        ...
        try
        {
            ...
            String strDesignatedUser = domObj.getInfo(context, "attribute[" + RequirementsUtil.getDesignatedUserAttribute(context) + "]");
    ...
    public static void updateDesignatedUser(Context context, String args[]) throws Exception
    {
        ...
        DomainObject domObj = DomainObject.newInstance(context, strObjectId);
        domObj.setAttributeValue(context, RequirementsUtil.getDesignatedUserAttribute(context), newValue); 
    } 
    ...
    public MapList getCommittedRequirementsList(Context context, String[] args)throws Exception
    {
        ...
        Model modelBean = (Model)DomainObject.newInstance(context,RequirementsUtil.getModelType(context),"PRODUCTLINE");
