...
#
   ...
   if {$sSpinnerPath == ""} {
      ...
      file mkdir "$sSpinnerPath/System/Map"
   }

   set sPath(local) "$sSpinnerPath/System/vault_local.xls"
   set sPath(remote) "$sSpinnerPath/System/vault_remote.xls"
   set sPath(foreign) "$sSpinnerPath/System/vault_foreign.xls"
   set sMapPath "$sSpinnerPath/System/Map"
