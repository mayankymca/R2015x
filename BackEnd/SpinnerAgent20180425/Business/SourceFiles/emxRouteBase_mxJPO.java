                ...
                sb.append("<br></br>");
                 ...
                 if( relatedObjectId != null ) {
                     ...
                     if(sTypeName.equals(DomainObject.TYPE_WORKSPACE) ||
                    		 isKindOfWorkspaceVault || //Modified:16-Mar-09:wqy:R207:PRG Bug 370839
...
@com.matrixone.apps.framework.ui.ProgramCallable
   public Vector getRouteAccessSummaryInheritedAccess (Context context, String[] args)
       throws Exception
   {
       HashMap programMap = (HashMap)JPO.unpackArgs(args);
       MapList objList = (MapList)programMap.get("objectList");
   ...
   @com.matrixone.apps.framework.ui.ProgramCallable
   public static MapList getInheritedAccessDetails(Context context, String[] args)
		   throws Exception
   {
	   HashMap programMap = (HashMap)JPO.unpackArgs(args);
   ...
   @com.matrixone.apps.framework.ui.ProgramCallable
   public Vector getRouteAccessInheritedFrom (Context context, String[] args)
       throws Exception
   {
       HashMap programMap = (HashMap)JPO.unpackArgs(args);
       MapList objList = (MapList)programMap.get("objectList");
   ...
   @com.matrixone.apps.framework.ui.ProgramCallable
   public Vector getRouteAccessInheritedType (Context context, String[] args)
	       throws Exception
	   {
	       HashMap programMap = (HashMap)JPO.unpackArgs(args);
	       MapList objList = (MapList)programMap.get("objectList");
   ...
   @com.matrixone.apps.framework.ui.ProgramCallable
   public Vector getRouteAccessInheritedTypeRev (Context context, String[] args)
	       throws Exception
	   {
	       HashMap programMap = (HashMap)JPO.unpackArgs(args);
	       MapList objList = (MapList)programMap.get("objectList");
	...
	@com.matrixone.apps.framework.ui.ProgramCallable
	public Vector getRouteCollectiveAccess (Context context, String[] args)
	       throws Exception
	   {
	       HashMap programMap = (HashMap)JPO.unpackArgs(args);
	       MapList objList = (MapList)programMap.get("objectList");
   ...
   public MapList getPersonsInWorkspace(Context context,String[] args) throws FrameworkException {
       try {
           ...
           //If Route scope is Project Space then we need get Project members 
          if(workspace.isKindOf(context, DomainConstants.TYPE_PROJECT_SPACE) && 
        		  (UIUtil.isNotNullAndNotEmpty(routeScopeType) && DomainConstants.TYPE_PROJECT_SPACE.equalsIgnoreCase(routeScopeType))) {
...
/*        try
	...
	*/
	...
	public static  String getRouteIdFromRouteTemplate(Context context, String strObjectId
	...
	/**
		     ...
		     * This trigger will check if user is admin, then remove command will be shown.
