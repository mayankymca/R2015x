...
# $RCSfile: eServicecommonTrigcInitiateRoute_if.tcl.rca $ $Revision: 1.44 $
#
# @libdoc       eServicecommonTrigcInitiateRoute_if
#
...
#******************************************************************************
# @procdoc      eServicecommonTrigcInitiateRoute_if.tcl
#
# @Brief:
#
# @Parameters:
...
#******************************************************************************
  ...
  #
  set progname      "eServicecommonTrigcInitiateRoute_if"
...
#  set mqlret [catch {eval eServicecommonInitiateRoute {$sType} {$sName} {$sRev} {1} {1}} outStr]
  set sCmd {mql execute program emxInitiateRoute -method eServicecommonInitiateRoute  "$sType"  "$sName"  "$sRev"  "1"  "1" }  
...
# end eServicecommonTrigcInitiateRoute_if
