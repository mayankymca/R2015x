...
public class emxBatchCGRConversionBase_mxJPO
{
	...
	public ArrayList getViewableObjects(Context context)
	{
		...
		String mqlcmd="temp query bus '" + TYPE_CGR + "' * * !expandtype where 'to[" + REL_VIEWABLE + "]==True' select to[" + REL_VIEWABLE + "].from.id id to[" + REL_VIEWABLE + "].from.from[" + REL_VIEWABLE + "].to[" + TYPE_3DXML + "].type to[" + REL_VIEWABLE + "].from.from[" + REL_VIEWABLE + "].to[" + TYPE_3DXML + "].id to[" + REL_VIEWABLE + "].from.from[" + REL_VIEWABLE + "].to[" + TYPE_3DXMLCGR + "].type to[" + REL_VIEWABLE + "].from.from[" + REL_VIEWABLE + "].to[" + TYPE_3DXMLCGR + "].id dump |";
		try{
