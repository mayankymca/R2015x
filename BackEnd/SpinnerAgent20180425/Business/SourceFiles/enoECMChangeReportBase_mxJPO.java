...
return newParts.toString();
 ...
 public String getCOAffectedItemsSummaryDetails(Context context,String[] args) throws Exception {
	...
	try {
		...
		mpAffectedPartList = getRelatedObjects(context,
			  strChangeAction, // relationship pattern
											"*",      // object pattern
											sListSelStmts,// object selects
											selectRelStmts, // relationship selects
											false,                // to direction
		...
		while (objItr.hasNext()) {
			...
			for (int i = 0; i < size; i++) {
				...
				newParts.append("<td>"+EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(),"emxFramework.Range.Requested_Change."+((String) slAIReqChanges.get(i)).replaceAll(" ", "_"))+"</td>");
				newParts.append("</tr>");
			}
		}

		if (mpAffectedPartList.size()==0) {
			newParts.append("<tr><td colspan=\"12\">"+EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(), "EnterpriseChangeMgt.Change.NoAffectedItemsConnected")+"</td></tr>");
		}
	} catch (FrameworkException Ex) {
	    throw Ex;
	}
...
String sRoute = "";
    ...
    for(int k = 0; k < mpListOfTasks.size() ; k++)
	 ...
	 {
		returnString.append("<tr><td class=\"even\" colspan=\"3\" align=\"center\" >"+ EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(),"EnterpriseChangeMgt.SummaryReport.NoSignOrRoutes")+"</td></tr>");
	 }
	...
	String strRelationType = ChangeConstants.RELATIONSHIP_IMPLEMENTED_ITEM;
	 ...
	 return specs.toString();
	  ...
	  returnString.append("<td><table width=\"100%\" border=\"0\" cellpadding=\"3\" cellspacing=\"0\" >");
	  returnString.append("<tr><td class=\"label\">"+EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(),"EnterpriseChangeMgt.Common.Description")+":</td><td class=\"inputField\">"+ecoDesc+"&nbsp;</td></tr>");
	  ...
	  returnString.append("<tr><td class=\"label\">"+EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(),"EnterpriseChangeMgt.Label.TechnicalApproversList")+"</strong>:&nbsp;</td><td class=\"inputField\">"+strApprovalRoute+"</td></tr>");
	...
	String strRelationType = ChangeConstants.RELATIONSHIP_CHANGE_AFFECTED_ITEM;
	 ...
	 if(specList.size()==0) {
	    specs.append("<tr><td colspan=\"6\">"+EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(),"EnterpriseChangeMgt.Change.NoAffectedItemsConnected")+"</td></tr>");
	 }
	 }
	 catch (FrameworkException Ex)
	 {
	 ...
	 return specs.toString();
	   ...
	   public  String getCOBasicInfo(Context context,String args[]) throws Exception {
			  ...
			  String strChange = isKindOf(context, ChangeConstants.TYPE_CHANGE_REQUEST)?(String)attributeMap.get("from["+sRelChangeOrder+"].to.name"):(String)attributeMap.get("to["+sRelChangeOrder+"].from.name");
			  strChange = UIUtil.isNotNullAndNotEmpty(strChange)?strChange:"";
			  String DisplayChangeLabel = isKindOf(context, ChangeConstants.TYPE_CHANGE_REQUEST)?EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(),"EnterpriseChangeMgt.Label.RelatedCO"):EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(),"EnterpriseChangeMgt.Label.RelatedCR");
			  ...
			  returnString.append("<tr><td class=\"label\">"+EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(),"EnterpriseChangeMgt.Label.ReviewersList")+"</strong>:&nbsp;</td><td class=\"inputField\">"+strReviewalRoute+"</td></tr>");
			  if(!isKindOf(context, ChangeConstants.TYPE_CHANGE_REQUEST))
			  returnString.append("<tr><td class=\"label\">"+EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(),"EnterpriseChangeMgt.Label.ApprovalList")+"</strong>:&nbsp;</td><td class=\"inputField\">"+strApprovalRoute+"</td></tr>");

			  returnString.append("<tr><td class=\"label\">"+EnoviaResourceBundle.getProperty(context, "emxEnterpriseChangeMgtStringResource", context.getLocale(),"EnterpriseChangeMgt.Label.DistributionList")+"</strong>:&nbsp;</td><td class=\"inputField\">"+strDistributionList+"</td></tr>");
