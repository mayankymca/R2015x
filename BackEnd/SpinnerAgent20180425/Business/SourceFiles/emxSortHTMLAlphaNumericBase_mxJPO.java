...
public class emxSortHTMLAlphaNumericBase_mxJPO extends emxCommonBaseComparator_mxJPO
{
    ...
    public int compare (Object object1,Object object2)
    {
        ...
        String string1 = "";
        String string2 = "";
        boolean isToSortOnNameColumn = "name".equalsIgnoreCase(keyName);
    ...
    {
    	String sReturnObjName = EMPTY_STRING;
    	if(mObject !=null){
    		sReturnObjName = (String)mObject.get(keyName);
    		if(sReturnObjName==null && "Name".equalsIgnoreCase(keyName)){
    			sReturnObjName = (String)mObject.get("Name");
    		}

    		StringList slParsedList = FrameworkUtil.split(sReturnObjName, "'");
    		if(!slParsedList.isEmpty() && slParsedList.size()>1){
    ...
    public int alphaNumericSort(String string1,String string2) {
    	...
    	while (index1 < lengthString1 && index2 < lengthString2) {
    		...
    		if (Character.isDigit(tempArray1[0]) && Character.isDigit(tempArray2[0])) {
    			...
    			str1 = str1.trim();  // Added for IR-496527-3DEXPERIENCER2015x
    			str2 = str2.trim();  // Added for IR-496527-3DEXPERIENCER2015x
