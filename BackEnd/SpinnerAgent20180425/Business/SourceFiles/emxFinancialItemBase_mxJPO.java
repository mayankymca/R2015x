...
//					}
				...
				double convertedAmount = Currency.convert(context, Task.parseToDouble(strPlannedBenefitValue), strPlannedBenefitUnitValue, strPrefferedCurrency, new Date(), false);
				...
				if(dmoType.equals(TYPE_PROJECT_SPACE)){
					...
					if(isExportable)
	      			...
	      			sbProjectLink.append("'>");                    
						sbProjectLink.append(XSSUtil.encodeForHTML(context,stri18nName));
