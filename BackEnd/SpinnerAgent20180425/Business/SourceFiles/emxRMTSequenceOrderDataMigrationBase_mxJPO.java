...
public class emxRMTSequenceOrderDataMigrationBase_mxJPO
{
    ...
    */
	...
	protected void migrateSequenceOrderToTreeOrder(Context context,String[] args) throws Exception
    {
        try
        {
        	String strType=RequirementsUtil.getSpecStructureRelationship(context) + "," + 
        				   RequirementsUtil.getSubRequirementRelationship(context)+ "," +
        				   RequirementsUtil.getDerivedRequirementRelationship(context)+ "," +
        				   RequirementsUtil.getRequirementGroupContentRelationship(context)+ "," +
        				   RequirementsUtil.getSubRequirementGroupRelationship(context)+ "," +
