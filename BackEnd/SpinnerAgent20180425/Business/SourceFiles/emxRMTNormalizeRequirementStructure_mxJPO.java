...
public class emxRMTNormalizeRequirementStructure_mxJPO extends emxRMTNormalizeRequirementStructureBase_mxJPO
{

    /**
         * Create a new emxRMTNormalizeRequirementStructure object from a given id
         *
        ...
        public emxRMTNormalizeRequirementStructure_mxJPO (Context context, String[] args)
            throws Exception {
          super(context, args);
        }
