...
/**
 * The <code>${CLASSNAME}</code> class contains implementation code for list out all the toplevel Configuration Features in the system.
 * This is the very first step of Migration.
 */
public class ConfigFeatureFlatteningFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO
{	
	 ...
	 */
	public ConfigFeatureFlatteningFindObjectsBase_mxJPO (Context context, String[] args)
	throws Exception
	{
		super(context, args);
	}
	...
	throws Exception
	{
		...
		typeList.append("Configuration Feature");
		
		String strTypePattern = typeList.toString();

		StringBuffer strRelPattern = new StringBuffer();

		String sbObjWhere = " to.from.type != 'Configuration Feature' && from.to.type == 'Configuration Feature' ";
		...
		catch (IllegalArgumentException iExp)
		{
			...
			writer.write("Step 2.1 of Migration ConfigFeatureFlatteningFindObjectsBase_mxJPO :   " + iExp.toString() + "   : FAILED!!!! \n");
			writer.write("=================================================================\n");
			writer.close();
			return 1;
		}finally{
	...
	public void setAdminMigrationStatus(Context context,String strStatus) throws Exception
	{
		...
		MqlUtil.mqlCommand(context, cmd, true, "eServiceSystemInformation.tcl", "ConfigFeatureFlatteningMigration", strStatus);
	}
	...
	{		
		...
		String result =	MqlUtil.mqlCommand(context, cmd, true, "eServiceSystemInformation.tcl", "property[ConfigFeatureFlatteningMigration].value");
