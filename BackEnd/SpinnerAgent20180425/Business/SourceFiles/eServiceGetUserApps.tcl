###############################################################################
#
# $RCSfile: eServiceGetUserApps.tcl.rca $ $Revision: 1.21 $
#
# Description:
# DEPENDENCIES:
#
...
###############################################################################
  ...
  set sProgName     "eServiceGetUserApps.tcl"
  ...
  set sInputLangType           [string toupper [string trim [mql get env 2]]]
         ...
         if {$mqlret == 0} {
                     ...
                     if {[string compare "$sSuiteName" "$sInputSuiteName"] == 0} {
                          ...
                          foreach lAppElement $lListApp {
                                  ...
                                  if {$iAppPropIndx == 0} {
                                             ...
                                             if {$sApplName != ""} {
                                                 append aCheckList "$DUMPDELIMITER$sApplName$DUMPDELIMITER"
          ...
          if {($mqlret == 0) && ($aCheckList != "")} {
                                                 ...
                                                 if {$sProgPageName != ""} {
                                                        ...
                                                        if {$sIndex > 0} {
                                                           ...
                                                           if {$mqlret != 0} {
                                                              ...
                                                              if {$outstr != ""} {
                                                                 append aAppList [string trim [lindex $lCheckListElement 1]]
                                                                 append aAppList $DUMPDELIMITER
                                                                 set iBreakSet  1
                                                                 break
                                                              }
                                                           }
              ...
              if {$aAppList == ""} {
                 ...
                 append aFinalList "0$DUMPDELIMITER$aAppList"
                 return $aFinalList
              }
          }
          if {$mqlret != 0} {
