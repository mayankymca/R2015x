          ...
          for (int i = 0; i < relBusObjPageList.size(); i++)
          {
              ...
              if(!isPrinterFriendly)
              {
                ...
                sbOutput.append("<a href=\"javascript:emxTableColumnLinkClick('" + strURL.toString() );
                              //Added for special character.
                              sbOutput.append(XSSUtil.encodeForJavaScript(context,strName));
                              sbOutput.append("&amp;emxSuiteDirectory=");
                              sbOutput.append(strSuiteDir);
                              sbOutput.append("', '600', '600', 'false', 'content','')\"  class='object'>");
                              //Added for special character.
    ...
    */    
    ...
    throws Exception
    {
    	...
    	try{
    		...
    		RiskURLPrefix = RiskURLPrefix.replace("${COMMON_DIR}","../common");
    		...
    		while (listItr.hasNext())
    		{
    			...
    			projectTasks.addSortKey(com.matrixone.apps.common.SubtaskRelationship.SELECT_TASK_WBS,"ascending", "integer");
    			projectTasks.sort();
    			...
    			/*if(minStr != null) {
    			 ...
    			 if(disply!=null) {
  				...
  				String   phaseEstEndDate = (String)disply.get(task.SELECT_TASK_ESTIMATED_FINISH_DATE);
  				String phaseActEndDate = (String)disply.get(task.SELECT_TASK_ACTUAL_FINISH_DATE);
...
*/
  				 ...
  				 String  CurrentPhaseDate= strFinishDate;
    			...
    			if (! mlBudget.isEmpty()){
					...
					if ((isFrozen == true) && (estimatedVal != 0)) {
						costratio =  (actualVal * 100) / estimatedVal;
    					}
    				} //End of If statement

                                projectMap.put("costRatio", String.format("%.3f", costratio)+"%");
    			...
    			//ADDED:12-July-2011:Di7:R212:PRG:IR-101863V6R2012x:START
    			newURL1 = newURL1.replace("table=PMCRisksSummary","table=PMCRiskDashboard");
    			//ADDED:12-July-2011:Di7:R212:PRG:IR-101863V6R2012x:END
    ...
    {       
    	...
    	for (int i = 0; i < objectList.size(); i++)
    	{
    		...
    		if(bCSVReportFormat){
    			currentPhase	=(String) relBusObjMap.get("currentPhase");
    ...
    */
    ...
    throws Exception
    {
        ...
        double timeZoneOffset= Double.valueOf(timeZone).doubleValue();
...
//      System.out.println("---setValues--->"+setValues);
    ...
    private Map getCurrentPhase(Context context, MapList list, String projectState) {
    	...
    	for(int i=0;i<list.size();i++){
            ...
            if(type.equals(ProjectSpace.TYPE_GATE)){
                ...
                if (ProgramCentralConstants.STATE_PROJECT_TASK_CREATE.equals(projectState) || ProgramCentralConstants.STATE_PROJECT_TASK_ASSIGN.equals(projectState)){
                    ...
                    String gateState = (String) tempMap.get(ProjectSpace.SELECT_CURRENT);
            ...
            else if(type.equals(ProjectSpace.TYPE_PHASE)){
