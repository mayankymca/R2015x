...
public class emxProgramBase_mxJPO extends com.matrixone.apps.program.Program
{
	...
	{
		// Check license while creating Program, if license check fails here
		// the programs will not be created.
		//
		...
		//Updating revision of newly created program object.
		String revision = program.getUniqueName(EMPTY_STRING);
