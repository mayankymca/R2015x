                ...
                if (CommonDocument.TYPE_DOCUMENTS.equals(parentType))
                {
                    ...
                    if((CommonDocument.canCheckin(context, contentObjectMap) || VCDocument.canVCCheckin(context, contentObjectMap)))
                    {
                        ...
                        if(!isprinterFriendly)
                        {
                            ...
                            if( !vcDocument )
                            {
                                strBuf.append("<a href=\"javascript:emxTableColumnLinkClick('../components/emxCommonDocumentIntermediatePreCheckin.jsp?objectId=");
                                strBuf.append(XSSUtil.encodeForJavaScript(context, documentId));
                                ...
                                strBuf.append("&amp;showFormat=true&amp;showComments=required&amp;objectAction=update&amp;JPOName=emxTeamDocumentBase&amp;appDir=teamcentral&amp;appProcessPage=emxTeamPostCheckinProcess.jsp&amp;refreshTableContent=true&amp;fromActionsColumn=true',730,450,false,'listHidden');\">");
                    ...
                    if(CommonDocument.canAddFiles(context, contentObjectMap))
                    {
                        if(!isprinterFriendly)
                        {
                            ...
                            strBuf.append("&amp;table=");
                            strBuf.append(XSSUtil.encodeForJavaScript(context, table));                   //Added for Bug #371651 ends
                            strBuf.append("&amp;showFormat=true&amp;showDescription=required&amp;objectAction=checkin&amp;showTitle=true&amp;JPOName=emxTeamDocumentBase&amp;appDir=teamcentral&amp;appProcessPage=emxTeamPostCheckinProcess.jsp&amp;refreshTableContent=true&amp;fromActionsColumn=true', '730', '450')\">");
   				 ...
   				 vcFile =(Boolean.valueOf((String) contentObjectMap.get("vcfile"))).booleanValue();
   				  ...
   				  //can unlock document 
   						...
   						if (isContextDocumentOwner || isAnyFileLockedByContext) {
                             ...
                             newURL+="<a href=\"javascript:submitWithCSRF("+strngBuf.toString()+", findFrame(getTopWindow(),'hiddenFrame'));\"><img style=\"border:0; padding: 2px;\" src=\"../common/images/iconActionUnlock.png\" alt=\""+docLocker+"\" title=\""+docLocker+"\"></img></a>";
                          }
