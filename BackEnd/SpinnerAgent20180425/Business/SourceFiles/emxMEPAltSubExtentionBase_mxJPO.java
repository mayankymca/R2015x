				...
				if(EngineeringUtil.isPartAuthorizedToHostCompany(context, strMEPId)){
					...
					if(ALTERNATE.equals(mepAltSubList.get(i))){
						...
						if(bHasModifyAccess){
							...
							cellData.append("<a href=\"javascript:showChooser('../common/emxIndentedTable.jsp?field=TYPES=type_Part&amp;table=ENCAlternateSubstitutePartSummary&amp;selection=multiple&amp;submitAction=refreshCaller&amp;MEPActions=DefineSubstitute&amp;submitURL=../engineeringcentral/emxEngrMEPUsage.jsp&amp;SubmitLabel=Done&amp;CancelButton=true&amp;objectId=");
							cellData.append(XSSUtil.encodeForURL(context, strMEPId));
							cellData.append("&amp;parentOID=");
							cellData.append(XSSUtil.encodeForURL(context, contextPartId));
							...
							cellData.append("<a href=\"javascript:showChooser('../common/emxIndentedTable.jsp?field=TYPES=type_Part&amp;table=ENCAlternateSubstitutePartSummary&amp;selection=multiple&amp;submitAction=refreshCaller&amp;MEPActions=RemoveSubstitute&amp;submitURL=../engineeringcentral/emxEngrMEPUsage.jsp&amp;SubmitLabel=Done&amp;CancelButton=true&amp;objectId=");
							cellData.append(XSSUtil.encodeForURL(context, strMEPId));
							cellData.append("&amp;parentOID=");
							cellData.append(XSSUtil.encodeForURL(context, contextPartId));
