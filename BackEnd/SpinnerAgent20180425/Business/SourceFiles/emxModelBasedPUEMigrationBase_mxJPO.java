...
import com.matrixone.apps.unresolvedebom.*;
 ...
 ( "******************Effectivity Maplist with for the given StringList of PUE ECO object ids :--\n" + mlEffectivity + "\n");
 ...
 ( "\n******************Selectable on PUE ECO ************\n"+mInfo);
					...
					/************* AFFECTED ITEM INFO **************/
				     ...
				     MapList affectedPartIds  = doChangeID.getRelatedObjects(context, EngineeringConstants.RELATIONSHIP_AFFECTED_ITEM,
