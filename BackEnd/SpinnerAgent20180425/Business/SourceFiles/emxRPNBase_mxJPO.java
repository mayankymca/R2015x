...
//  Constructor
     ...
     * @since PMC V6R2008-1
     */
    public String getImpact(Context context,String args[]) throws Exception
    {
    ...
    {
        StringBuffer sb = new StringBuffer();
        sb.append("<input name=\"RPN\" size=\"2\" value=\"25\" maxlength=\"2\" readonly=\"readonly\">");
    ...
    public void editRPN(Context context,String args[]) throws Exception
    {
        ...
        try
        {
            ...
            HashMap riskInfoMap = new HashMap();
	            ...
	            riskInfoMap.put(DomainConstants.ATTRIBUTE_RISK_IMPACT,Impact);
	            riskInfoMap.put(DomainConstants.ATTRIBUTE_RISK_PROBABILITY,Probability);
	            risk.setAttributeValues(context, riskInfoMap); 
