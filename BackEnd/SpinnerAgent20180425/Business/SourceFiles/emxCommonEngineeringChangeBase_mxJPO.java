...
outPut.append("&nbsp;&nbsp;<a href=\"javascript:basicClear('ReviewerList')\">"+strClear+"</a>");
    ...
    public int checkValidationStatus(Context context, String[] args)
        ...
        if (isValidationRequiredEC(
            ...
            String strOriginatedDate = MqlUtil.mqlCommand(
                    context, sbMqlCommand.toString());
 ...
 return lstActiveECIcon;
  ...
  /**
    ...
    * @since AEF 10.6
    */
        public String hasAccess(Context context,String args[])
                                                                throws Exception{
...
/**
    ...
    * @since AEF 10.6
    */
    protected void modifyHistory(Context context ,
                                              String strObjectId,
                                              String strAction,
                                              String strComment)
                                                        throws Exception{
