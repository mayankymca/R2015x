  ...
  try {
    ...
    protected void migrateDecisionRels(Context context,String[] args) throws Exception
    {
        try
        {
			...
			String strNewRelType = RequirementsUtil.getDecisionRelationship(context);
			
			List lstDecisionTypes = ProductLineUtil.getChildrenTypes(context, RequirementsUtil.getDecisionType(context));
			lstDecisionTypes.add(RequirementsUtil.getDecisionType(context));
