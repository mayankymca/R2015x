...
//  IR-047371V6R2011 - END
     ...
     /*       Collection obPersonIds    = null;
			...
			if(route.checkIfSubsidiaryOrgMembersEnabled(context)){
				...
				slCompanies.addAll( domObjPerson.getInfoList(context,
				...
				List<Map> mlRT=DomainObject.findObjects(context,  DomainObject.TYPE_ROUTE_TEMPLATE,
						DomainConstants.QUERY_WILDCARD, objWhere, selectStmts);
...
public String showRouteTemplateAvailability(Context context, String[] args) throws Exception
{
    ...
    if(person.hasRole(context,DomainObject.ROLE_ORGANIZATION_MANAGER) || person.hasRole(context,DomainObject.ROLE_COMPANY_REPRESENTATIVE) || PersonUtil.hasAssignment(context, sVPLMProjectLeaderRole))
    {
