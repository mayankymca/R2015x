...
public class emxEngineeringConfiguredPartMigrationFindObjectsBase_mxJPO extends emxCommonFindObjects_mxJPO
{
    ...
    public void getIds(Context context, int chunkSize) throws Exception
    {
        ...
        try
        {
			...
			String whereclause = "policy == \"" + UnresolvedEBOMConstants.POLICY_CONFIGURED_PART + "\" && (from[" + DomainConstants.RELATIONSHIP_EBOM + "] == True || from[" + UnresolvedEBOMConstants.RELATIONSHIP_EBOM_PENDING + "] == True)";
