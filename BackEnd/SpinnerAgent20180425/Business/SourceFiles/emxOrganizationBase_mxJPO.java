     ...
     */
     ...
     public MapList getRootObjectForSelectOrganization(Context context, String[] args) throws FrameworkException {
         try {
             ...
             if(!UIUtil.isNullOrEmpty(objectId)){
                 ...
                 companyId = !TYPE_COMPANY.equals(contextObj.getInfo(context, SELECT_TYPE)) ?
                              ComponentsUtil.getCompanyIdForChildObjectId(context, objectId) : objectId;
             }
     ...
     public MapList selectionOwningOrganizationExpandProgram(Context context, String[] args) throws FrameworkException {
         try {
             ...
             if(route.checkIfSubsidiaryOrgMembersEnabled(context)&&(Person.getPerson(context).getCompanyId(context)).equals(orgId)){
