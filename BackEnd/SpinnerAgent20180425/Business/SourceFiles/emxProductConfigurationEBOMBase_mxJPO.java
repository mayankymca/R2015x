   ...
   public Vector getCustomActionIconsForDisplay(Context context, String args[])throws Exception {
	   ...
	   for (int i = 0; i < objectList.size(); i++)
	   {
		   ...
		   if (parts.size() > 0)
		   {
			   ...
			   if (isECInstalled)
			   {
				   stbNameRev = stbNameRev.append("<a><img src=\"../common/images/iconActionCreateNewPart.gif")
				   .append("\" border=\"0\"  align=\"middle\" ")
				   .append("TITLE=\"")
				                            .append(i18CreateNew)
				   .append("\"")
			   ...
			   stbNameRev = stbNameRev.append(" <a><img src=\"../common/images/iconActionAddExistingPart.gif")
			   .append("\" border=\"0\"  align=\"middle\" ")
			   .append("TITLE=\"")
				                        .append(i18AddExisting)
