...
public class emxUseCaseBase_mxJPO extends emxDomainObject_mxJPO 
{
    ...
    public MapList getUseCasesWhereUsed (Context context, String[] args) throws Exception {
        ...
        String strUseCaseSubUseCaseReln = RequirementsUtil.getSubUseCaseRelationship(context);
        String strUseCaseRequirementReln = RequirementsUtil.getRequirementUseCaseRelationship(context);
        String strUseCaseFeatureReln = RequirementsUtil.getFeatureUseCaseRelationship(context);
        String strComma = ",";
   ...
   /** This method gets the object Structure List for the context Use Case object.This method gets invoked
    ...
    public static MapList getStructureList(Context context, String[] args) throws Exception {
        ...
        Pattern relPattern = new Pattern(RequirementsUtil.getSubUseCaseRelationship(context));
        relPattern.addPattern(RequirementsUtil.getUseCaseValidationRelationship(context));

        // include type 'Use Case, Test Case' in Use Case structure navigation list
        Pattern typePattern = new Pattern(RequirementsUtil.getUseCaseType(context));
        ...
        if(objectType != null && objectType.equals(RequirementsUtil.getUseCaseType(context))){
            try{
