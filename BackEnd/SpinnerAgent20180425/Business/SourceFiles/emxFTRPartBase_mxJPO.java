   ...
   //R207 GBOM Part Updates end
	...
	public MapList getActiveGBOMStructure(Context context, String[] args)
		...
		MapList objectList = logicalFTR.getActiveGBOMStructure(context,
				typePattern, relPattern, objSelects, relSelects, false, true,
				1, 0, objWhere, relWhere, DomainObject.FILTER_STR_AND_ITEM,
				filterExpression);
  		...
  		try{
  	       ...
  	       //For Replace GBOM
  			...
  			for (int i = 0; i < objectList.size(); i++)
  			{
  				...
  				strBufferIcons.append(XSSUtil.encodeForHTMLAttribute(context, strCustomInactiveTargetLoc)+"' ,"+ "'InactiveGBOM'" + " ,'"+XSSUtil.encodeForHTMLAttribute(context, strConnectionId)+"'");
