...
# $RCSfile: eServicecommonUtFileCreateTmpDir.tcl.rca $ $Revision: 1.17 $
#
# @libdoc       eServicecommonUtFileCreateTempDir.tcl
#
# @Library:     Tcl File Procedures
#
# @Brief:       Program to create temp file
#
# @Description:
...
set sTempDir [utFileCreateTmpDir]
return $sTempDir
}
