...
public class emxImageManagerBase_mxJPO extends emxCommonDocument_mxJPO
{
 ...
 /**
   ...
   /**
    ...
    public Vector getImageURLs(Context context, String[] args) throws Exception {
        ...
        try {
            ...
            while( imageItr.hasNext()) {
                ...
                finalImageURLs.add(getImageColumnInfo(imageSize, allCADImages, fcsImageURLs[count], count, (String)imageItr.next(), oidsArray[count], imageViewerLink, generateHTML, (String)objectTypeList.get(count)));
                count ++;
            }
    ...
    protected Object getImageColumnInfo(String imageSize, StringList allCADImages, String fcsImageURL, int count, String imageName, String oid, String imageViewerURL, boolean generateHTML, String objectType) {
...
/*
  ...
  */
  ...
  public void checkinThumbnailImagetoDocument(Context context, String args[]) throws Exception {	  
     ...
     * @since AppsCommon 10.7.SP1
     */
    public HashMap getImagesFromAltPath(Context context,String parentId,String primaryImage,HashMap imageData,boolean forPrimaryImage, Map imageInfo)
    throws Exception
    {
