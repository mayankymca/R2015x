...
public class emxPartMarkupBase_mxJPO extends emxDomainObject_mxJPO {
  ...
  //IR-019321 - Ends
     ...
     public static int mergeMarkupsonChange(Context context, String args[]) throws Exception
    {
        ...
        MapList mapListParts = doChange.getRelatedObjects(context,
              ...
              if ("A".equals(strEBOMChgType))
              {
                  ...
                  //HF-050350 Ends
				   ...
				   if(strCurrent.equals(DomainObject.STATE_PART_OBSOLETE)){
                       ...
                       if(!(strParentState.equals(DomainObject.STATE_PART_APPROVED))||(!(strCurrent.equals(DomainObject.STATE_PART_APPROVED))&& !(strCurrent.equals(DomainObject.STATE_PART_RELEASE)))){
							String [] mailArguments = new String [12];
							mailArguments[0] = "emxEngineeringCentral.Alert.ObjectState";
							mailArguments[1] = "4";
							mailArguments[2] = "strObjType";
                  ...
                  //End - Added for EBOM Substitute Mass change
                      ...
                      else
                      {
                    	  String[] messageValues = new String[7];
      		              ...
      		              messageValues[1] = messageValues[4] = EnoviaResourceBundle.getProperty(context, "emxEngineeringCentralStringResource", context.getLocale(),"emxEngineeringCentral.Common.Part");
      		              ...
      		              String strErrorMsg = MessageUtil.getMessage(context,null,"emxEngineeringCentral.MarkupActions.ApplyErrorMsg",messageValues,null,context.getLocale(),"emxEngineeringCentralStringResource");
...
public void rejectMarkup(Context context, String[] args) throws Exception {
    ...
    for (int i = 0; i < dataSize; i++) {
    	...
    	if (strMarkupOwner.equals(strContextUser)
    			...
    			|| getListValue(dataMap, SELECT_ASSIGNEES).contains(strContextUser)
    				|| getListValue(dataMap, SELECT_ECR_ASSIGNEES_FROM_MARKUP_OBJ).contains(strContextUser) || getListValue(dataMap, SELECT_TECHNICAL_ASSIGNEES).contains(strContextUser)) { //Modified for IR-162940
			...
			if (canDelete) {
				...
				if (strContextUser.equals((String) map.get(SELECT_OWNER))
						...
						|| getListValue(map, SELECT_ASSIGNEES).contains(strContextUser)
							|| getListValue(map, SELECT_ECR_ASSIGNEES_FROM_MARKUP_OBJ).contains(strContextUser) || getListValue(map, SELECT_TECHNICAL_ASSIGNEES).contains(strContextUser)) { //Modified for IR-162940
               ...
               if(!DomainConstants.POLICY_DEVELOPMENT_PART.equals(strPartPolicy) &&(currentState.equals(approvedState)))
                {
					...
					String strPartVer = doPart.getInfo(context, PropertyUtil.getSchemaProperty(context,"attribute_IsVersion"));
                        ...
                        if((strPartCurrentRev.equals(strPartCurrentFirstRev) && "FALSE".equals(strPartVer) && strPartState.equals(DomainConstants.STATE_PART_PRELIMINARY))  || strPartState.equals(DomainConstants.STATE_PART_APPROVED) || TYPE_PLANT_BOM_MARKUP.equals(strMarkupType))
   ...
   public String createAndConnectMarkup(Context context, DomainObject domPart, DomainObject domChange) throws Exception
    {
       ...
       try{
           ...
           ContextUtil.pushContext(context);
           dmRelPartMarkup = DomainRelationship.connect(context,
                                                         domPart,
           ...
           dmRelChangeMarkup = DomainRelationship.connect(context,
                                                         domChange,
                                                         sConnectRelName,
                                                         domMarkup);
           ContextUtil.popContext(context);
          ...
          //Added for IR-077316V6R2013 end
            ...
            if("view".equals(sAction))
            {
                ...
                for( int index=0; index < arrFile.length; index +=3)
                {
                    ...
                    if(arrFile[index+1].indexOf("_") != -1) arrFile[index+1] = StringUtils.replaceAll(arrFile[index+1],"_","");
                        if(arrFile[index+2].indexOf("_") != -1)  arrFile[index+2] = StringUtils.replaceAll(arrFile[index+2], "_","");
                        ...
                        if(arrFile[index+1].equals(arrFile[index+2])){
                          ...
                          //IR-017226 - Ends
                        	...
                        	//Multitenant
                        	  arrFile[index+2] = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(),"emxFramework.Range." + attrName1 +"."+ arrFile[index+2]);
                        ...
                        else
                        {
                          ...
                          //IR-017226 - Ends
                        	...
                        	//Multitenant
                        	  arrFile[index+2] = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(),"emxFramework.Range." + attrName1 +"."+ arrFile[index+2]);
                        	//Multitenant
                        	  arrFile[index+1] = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(),"emxFramework.Range." + attrName1 +"."+ arrFile[index+1]);
                          //IR-017226 - Starts
                          }
                          //IR-017226 - Ends
                ...
                while(checkItr.hasNext())
                {
                    ...
                    else if ("A".equals(sChangeType)) //if the operation is ADD
                    {
                        if ((DomainConstants.RELATIONSHIP_ALTERNATE).equals(sRelName.trim()))
                        {
                            ...
                            try
                            {
								String sRelid = MqlUtil.mqlCommand(context,"print bus $1 select $2 dump $3",sSelectedId,"from["+EngineeringConstants.RELATIONSHIP_ALTERNATE+"|to.id=="+sAlternateObjId+"].id","|");
								if("".equals(sRelid))
								{
									RelToRelUtil relObj = new RelToRelUtil();
    ...
    */
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            strRelWhere.append("')");
            MapList mlMRObjs = dmPartMaster.getRelatedObjects(context, RELATIONSHIP_MANUFACTURING_RESPONSIBILITY, TYPE_PLANT, busSelList, relSelList, true, false, (short)1, "", strRelWhere.toString());
            int iSeq = 0;
            int iHighestSeq = 0;
    ...
    **/
	...
	public boolean isMarkupCreateAllowed(Context context,
		...
		if(getWhereUsed != null && !("".equals(getWhereUsed)) && "true".equalsIgnoreCase(getWhereUsed)) { 
			return !(policyClassification != null && !("".equals(policyClassification)) && 
					(("Unresolved".equals(policyClassification)) ||("Development".equals(policyClassification))));
		}
		else
			return true;
    ...
    public String getImplementedItem(Context context, String args[])	throws Exception
	{
		...
		MapList mapListParts = doECO.getRelatedObjects(context,
				ChangeConstants.RELATIONSHIP_IMPLEMENTED_ITEM, strPartType, strlObjectSelects,
                    null, false, true, (short) 1, strObjWhereclause, null);
    ...
    /**
     * This API determines whether part is already connected to this change and evaluates if the given part is actually eligible 
     * to connect to change order/change request based on its state according to ENG rules.
     * 
     * --- Verifies if the given part is already connected to the given change in form of Affected or implemented items. 
     * 	   if it is connected then returns map with key ALREADY_CONNECTED and value TRUE along with connected CA info 
     * 	   else returns map with key ALREADY_CONNECTED and value FALSE	 
     * 		 
     * @param context
     * @param partId   -- Part Object Id which is mandatory
     * @param changeId -- Change Object id which is mandatory
    ...
    public static MapList getImplementedItems(Context context, String changeId) throws FrameworkException {
		...
		StringList relSelects   = new StringList();
		 try {
			...
			MapList dataList = dO.getRelatedObjects(context,
							 					  relPattern,
