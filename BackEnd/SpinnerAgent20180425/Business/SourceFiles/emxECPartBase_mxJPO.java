...
//Modified for bug # 359417 - starts
        ...
        if (strReportFormat != null && (strReportFormat.indexOf("getExpandedEBOM") != -1 || strReportFormat.indexOf("getDelimitedRollupEBOM") != -1 || strReportFormat.indexOf("getRangeRollupEBOM") != -1))
        {
			while (i.hasNext())
			{
				Map m = (Map) i.next();
    		...
    		String[] args)throws Exception
    {
    	...
    	try{
    		...
    		while (i.hasNext())
    		{
    			...
    			{
    				output.append("<a href=\"JavaScript:emxTableColumnLinkClick('../common/emxTree.jsp?objectId="+ XSSUtil.encodeForURL(context, sPartid) +"', '700', '600', 'false', 'popup', '')\">"+XSSUtil.encodeForHTML(context,sPartName)+"</a> <br> </br>");
    			}
...
//end of fix for bug 311050
    ...
    * @param args 2 - parentOID - parent object ID
    ...
    selectRelStmts.addElement(partObj.SELECT_RELATIONSHIP_ID);
      ...
      if ((ctxPolicy.equals(DomainConstants.POLICY_DEVELOPMENT_PART) && !"Complete".equals(state)) || (ctxPolicy.equals(DomainConstants.POLICY_EC_PART) && state.equals(DomainConstants.STATE_PART_PRELIMINARY)) ) {
...
//      Getting i18n string for tokens
    ...
    */
    ...
    throws Exception
    {
        ...
        strBuf.append("<SELECT name=\"ExpandLevel\" > <OPTION value=\"1\" SELECTED >1 <OPTION value=\"2\">2 <OPTION value=\"3\">3 <OPTION value=\"4\">4 <OPTION value=\"5\">5 <OPTION value=\"0\">"+EnoviaResourceBundle.getProperty(context, "emxEngineeringCentralStringResource", context.getLocale(),"emxEngineeringCentral.Common.All")+" </SELECT>");
   ...
   /**
     ...
     public MapList lookupEntries(Context context, String[] args) throws Exception
     {
        ...
        StringList objectSelect = createStringList(new String[] {
				DomainConstants.SELECT_ID, DomainConstants.SELECT_CURRENT });
    ...
    public String displayVName(Context context, String[] args) throws Exception{
        ...
        if(itr.hasNext()) {
            ...
            if(reportFormat == null || "".equals(reportFormat)) {
	            ...
	            strBuf.append("','popup', '', '', '')\">");
	            strBuf.append("<img src=\"images/I_VPMNavProduct.png\" alt=\"VPM Product : " +
	                        XSSUtil.encodeForHTML(context, productName) + "\" title=\"VPM Product : " +  XSSUtil.encodeForHTML(context,productName) + "\" border=\"0\" align=\"absmiddle\"></img>");
	            strBuf.append("</a>&nbsp;");
            }
        }
    	return strBuf.toString();
...
// Added by vinod for migration of Specification to Common Component -- Start
	...
	public Map createPartJPO(Context context, String[] args) throws Exception {
		...
		try {
			...
			strPartId = part.createPart(context, sType, sName,
					sCustomRevisionLevel, sPolicy, sVault, sOwner,
					sAutoNameChecked, sPartFamilyId, sAutoNameSeries);
...
throws Exception { //IR:073691
  ...
  /**
    ...
    throws Exception {
        ...
        try {
            ...
            if("MFG".equals(strPartCreateMode) && !"Synthetic Part".equals(strType) &&  !"Kit Part".equals(strType)
            		&& !"type_SyntheticPart".equals(strType) &&  !"type_KitPart".equals(strType) ) {
                displayField = Boolean.TRUE;
            }
        } catch (Exception ex) {
            ex.printStackTrace();
 ...
 String findNumberPadding(String fnValue) throws Exception {
 	...
 	public MapList expandEBOM(Context context, HashMap paramMap) throws Exception {  //name modified from getEBOMsWithRelSelectablesSB
		...
		StringList objectSelect = createStringList(new String[] {SELECT_ID, SELECT_TYPE, SELECT_REVISION, SELECT_LAST_ID, SELECT_LAST_REVISION,
																		SELECT_REL_FROM_EBOM_EXISTS,SELECT_REL_EBOM_FROM_LAST_REVISION_EXISTS, SELECT_ATTR_ENABLE_COMPLIANCE});
	...
	public int ensureECOConnected(Context context, String[] args)
	  throws Exception
	  {
			...
			else
			{
				...
				String langStr = context.getSession().getLanguage();
				String strMessage = EngineeringUtil.i18nStringNow(context,"emxEngineeringCentral.CheckIfECOConnected.Message1",langStr) + " " + EngineeringUtil.i18nStringNow(context,"emxEngineeringCentral.ChangeOrderChangeAction",langStr) + " " + EngineeringUtil.i18nStringNow(context,"emxEngineeringCentral.CheckIfECOConnected.Message2",langStr) +" "+  EnoviaResourceBundle.getProperty(context,"emxFrameworkStringResource",context.getLocale(),"emxFramework.Relationship.Change_Affected_Item") + ", " + EnoviaResourceBundle.getProperty(context,"emxFrameworkStringResource",context.getLocale(),"emxFramework.Relationship.Implemented_Item");
				emxContextUtil_mxJPO.mqlNotice(context,strMessage);
				return 1;
			}
		}
...
*/
    	...
    	if(UIUtil.isNotNullAndNotEmpty(PartSeriesON) && "TRUE".equalsIgnoreCase(PartSeriesON)){	 	    		
			...
			if( previousRevObj != null && (!(previousRevObj.toString().trim().equals(".."))  ||  !(previousRevObj.getTypeName().equals("")))){
	    		...
	    		if((SYMB_R.equals(sRefType) && (strState.equalsIgnoreCase(STATE_PART_PRELIMINARY)||strState.equalsIgnoreCase(STATE_DEVELOPMENT_PART_CREATE))) || (SYMB_M.equals(sRefType)&& (strState.equalsIgnoreCase(STATE_PART_RELEASE)||strState.equalsIgnoreCase(STATE_DEVELOPMENT_PART_COMPLETE)))){
		    		sContextPartFamilyId = (String)doPrevRevObjId.getInfo(context, "relationship["+RELATIONSHIP_CLASSIFIED_ITEM+"].tomid["+RELATIONSHIP_PART_FAMILY_REFERENCE+"].torel.from.id");
    ...
    throws Exception {
	    ...
	    String nameLinkSrcBeg = new StringBuilder("<a href=\"JavaScript:emxTableColumnLinkClick('../common/emxTree.jsp?emxSuiteDirectory=")
	    .append(XSSUtil.encodeForJavaScript(context,suiteDir))
	    .append("&amp;suiteKey=")
	    .append(XSSUtil.encodeForJavaScript(context,suiteKey))
	    .append("&amp;jsTreeID=")
...
public String getPartConnectedProduct(Context context, String[] args)
    throws Exception {
