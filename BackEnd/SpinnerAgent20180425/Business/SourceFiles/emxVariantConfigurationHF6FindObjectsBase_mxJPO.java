...
public class emxVariantConfigurationHF6FindObjectsBase_mxJPO extends
     ...
     * @grade 0
     */
    public emxVariantConfigurationHF6FindObjectsBase_mxJPO(Context context,
    ...
    public int findObjects(Context context, String[] args) throws Exception {
        ...
        sargs[0] = "" + chunkSize;
        sargs[1] = ConfigurationConstants.TYPE_FEATURE_LIST + ","
                + ConfigurationConstants.TYPE_RULE + ","
                + ConfigurationConstants.TYPE_BOOLEAN_COMPATIBILITY_RULE + ","
                + PropertyUtil.getSchemaProperty(context,"type_BOM_Rules") + ","
    ...
    /**
     * This method is executed to find the object ids of type Features and
     * Product Configuration for migration
     *
     * @param context
     *            the eMatrix <code>Context</code> object
     * @param args
    ...
    public int findObjectsOfTypeFeaturesandProductConfiguration(Context context, String[] args) throws Exception {
        ...
        String[] sargs = new String[3];
        sargs[0] = "" + chunkSize;
        sargs[1] = ConfigurationConstants.TYPE_FEATURES + ","
     ...
     *             if the operation fails
     */
    public int findRelationship(Context context, String[] args)
            throws Exception {
