        ...
        throws Exception
    {
        try
        {
			...
			else if(sEvent.equals("Promote"))
			{
				...
				MqlUtil.mqlCommand(context, "modify person \""+personName+"\" type active \""+sEmailFlag+"\" email enable iconmail", true);
			}
    ...
    */
	...
	public void createPersonalWorkspace(Context context, String[] args) throws Exception
    {
        try
        {
            ...
            MqlUtil.mqlCommand(context, cmd, TYPE_PERSONAL_WORKSPACE, strPersonalWorkspaceName, personName, POLICY_PERSONAL_WORKSPACE, person.getDefaultVault(context, person), personName, personName+"_PRJ",orgName);
        }
        catch(Exception ex)
        {
        	ex.printStackTrace();
